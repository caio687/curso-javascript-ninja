(function() {
  ...
  */
  ...
  let justMod20r3 = justNumbers.filter((item, index, array) => {
  ...
  */
  ...
  let operation = justMod20r3.reduce((acumulado, atual, index, array) => {
  ...
  console.
  */
  let operation2 = justMod20r3.reduceRight((acumulado, atual, index, array) => {
    return (acumulado + 1) * atual
  }, 0)
