(function() {
  ...
  */
  ...
  let pessoa1 = new Person('Caio', 'Santos', 28)
  let pessoa2 = new Person('Gisele', 'Nascimento', 29)
  let pessoa3 = new Person('Muito', 'Estranho', 32)
  ...
  */
  ...
  console.log(pessoa1.addAge(2))
  console.log(pessoa2.addAge(2))
  console.log(pessoa3.addAge(2))
