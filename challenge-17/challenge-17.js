(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Caio Santos'))
  ...
  */
  ...
  console.log(text.replace(/(O) (Centauro) (de) (Luvas)/, function(totalCapturado) {
    return totalCapturado.toUpperCase()
  }))
